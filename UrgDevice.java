public class UrgDevice implements RangeSensor {
    ...
    @Override
    public void setConnection(Connection con) {                                        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////链接方式赋值
        myConnection = con;
    }
   ...
   // public boolean setCaptureMode(CaptureMode mode) {                                    //*************************************************************************************设置访问模式
     public boolean setCaptureMode(CaptureSettings.CaptureMode mode) {  
    ...
    public boolean startCapture() {                                                                                           //*******************************************************开始获取数据
        if (myCapture == null) {
